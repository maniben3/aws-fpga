...
int peek_poke_example(uint32_t value, int slot_id, int pf_id, int bar_id) {
    ...
    for (i = 0; i < 20; i++) {
                        ...
                        uint32_t block[]={0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000};
